 ...
 * @author wb
 */
public class RecResultWindow extends JFrame implements ActionListener{
    ...
    public RecResultWindow(List<Recombinant> results, JFrame parentFrame){
    ...
    private void init(){
        ...
        this.setTitle("GRecScan--Recombiantion detection results");
...
//        ((JLabel)reclistBox.getRenderer()).setHorizontalAlignment(SwingConstants.RIGHT);
    ...
    private void fillCenterPanel() {
        RecPlot plot=new RecPlot(rec);
        centerPanel.add(plot.getPlotPanel());
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==seqButton){
            ...
            Alignment aln=mf.getPipeline().getAln();
